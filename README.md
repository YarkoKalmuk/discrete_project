...
2. **Кальмук Ярополк**: Створення функції `unconnected_places`, яка визначає всі населені пункти, що залишились без сполучення з обласним центром, і повертає список груп з'єднаних компонентів та функції `main`, яка об'єднує всі допоміжні функції.
